...
_prompt2.default.el = '#root';
new Vue(_prompt2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/modal/prompt.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-69750d20"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    prompt: function prompt() {
      _natjs2.default.prompt('this is a simple prompt dialog');
    },
    promptCustom: function promptCustom() {
      _natjs2.default.prompt({
        title: 'Title',
    ...
    promptWithCb: function promptWithCb() {
      _natjs2.default.prompt('this is a prompt dialog with callback', function (err, ret) {
        _natjs2.default.toast(ret.result ? ret.data : 'canceled');
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.prompt('this is a simple prompt dialog')\n      ")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.promptCustom
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.prompt({\n            title: 'Title',\n            message: 'Are you feeling lucky?',\n            text: 'sure',\n            okButton: 'Yep',\n            cancelButton: 'Ignore'\n        })\n      ")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.promptWithCb
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.prompt({\n            title: 'Title',\n            message: 'Are you feeling lucky?',\n            text: 'sure',\n            okButton: 'Yep',\n            cancelButton: 'Ignore'\n        }, (err, ret) => {\n            Nat.toast((ret.result) ? ret.data : 'canceled')\n        })\n      ")])])], 1)], 1)
