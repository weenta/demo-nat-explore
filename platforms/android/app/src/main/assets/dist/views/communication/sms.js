...
var _sms = __webpack_require__(75);

var _sms2 = _interopRequireDefault(_sms);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_sms2.default.el = '#root';
new Vue(_sms2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/communication/sms.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-77ef38f6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    sms: function sms() {
      _natjs2.default.sms('415-736-0000');
    },
    mutilSms: function mutilSms() {
      _natjs2.default.sms(['10000', '10086']);
    },
    mutilSmsWithCb: function mutilSmsWithCb() {
      _natjs2.default.sms(['10000', '10086'], 'hello world', function () {
        _natjs2.default.toast('sms popup');
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.mutilSmsWithCb
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.sms(['10000', '10086'],'hello world',()=>{\n          Nat.toast('sms popup')\n        })\n      ")])])], 1)], 1)
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Sms with content and callback")])])
}]}
module.exports.render._withStripped = true
