...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/media/audio.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4b74c841"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    play: function play() {
      _natjs2.default.audio.play('http://cdn.instapp.io/nat/samples/audio.mp3');
    },
    playWithCb: function playWithCb() {
      _natjs2.default.audio.play('http://cdn.instapp.io/nat/samples/audio.mp3', function (err) {
        if (err) {
          _natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
          return;
        }

        _natjs2.default.toast('started');
      });
    },
    pause: function pause() {
      _natjs2.default.audio.pause(function () {
        _natjs2.default.toast('paused');
      });
    },
    stop: function stop() {
      _natjs2.default.audio.stop(function () {
        _natjs2.default.toast('stoped');
      });
    }
  }
};
