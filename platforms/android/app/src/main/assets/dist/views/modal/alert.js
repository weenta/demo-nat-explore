...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/modal/alert.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-37fa3360"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    alert: function alert() {
      _natjs2.default.alert('what\'s up');
    },
    alertCustom: function alertCustom() {
      _natjs2.default.alert({
        title: 'Title',
        message: 'This is an alert dialog',
        okButton: 'I know'
      });
    },
    alertWithCb: function alertWithCb() {
      _natjs2.default.alert('this is an alert with callback', function () {
        _natjs2.default.toast('alerted.');
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.alertWithCb
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.alert('this is an alert with callback',()=>{\n          Nat.toast('alerted')\n        })\n      ")])])], 1)], 1)
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Alert with title,message and button")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["header"]
  }, [_c('text', {
