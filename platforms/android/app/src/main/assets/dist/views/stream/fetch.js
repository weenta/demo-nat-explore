...
var _fetch = __webpack_require__(120);

var _fetch2 = _interopRequireDefault(_fetch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_fetch2.default.el = '#root';
new Vue(_fetch2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/stream/fetch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-d43709f6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    fetch: function fetch() {
      _natjs2.default.fetch(this.url, function (err, res) {
        if (err) {
          console.log('--------->err', err);
        ...
        _natjs2.default.toast(JSON.stringify(res));
      });
    }
  }
};
