...
var _recorder = __webpack_require__(109);

var _recorder2 = _interopRequireDefault(_recorder);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_recorder2.default.el = '#root';
new Vue(_recorder2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/recorder/recorder.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-261b7e76"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    start: function start() {
      _natjs2.default.recorder.start({}, function (err) {
        if (err) {
    ...
    pause: function pause() {
      _natjs2.default.toast('click pause');
      _natjs2.default.recorder.pause({}, function (err) {
        if (err) {
          _natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
          return;
        }
    ...
    stop: function stop() {
      _natjs2.default.toast('click stop');
      _natjs2.default.recorder.stop({}, function (err) {
        if (err) {
          _natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
          return;
        }
