...
var _captureImage = __webpack_require__(55);

var _captureImage2 = _interopRequireDefault(_captureImage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_captureImage2.default.el = '#root';
new Vue(_captureImage2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/camera/captureImage.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0bf0fab5"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    preview: function preview() {
      if (!this.path) {
        _natjs2.default.toast('please take photo first');
        return;
      }

      _natjs2.default.image.preview(this.path);
    }
  }
};
