...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/media/image.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0be58b46"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
  ...
  methods: {
    pick: function pick() {
      _natjs2.default.image.pick({
        ...
        _natjs2.default.toast('选择相片');
        console.log(ret.paths);
      });
    },
    preview: function preview() {
      _natjs2.default.image.preview(['http://cdn.instapp.io/nat/samples/yellow-metal.jpg', 'http://cdn.instapp.io/nat/samples/bnw.jpeg', 'http://cdn.instapp.io/nat/samples/fibonacci.jpeg'], {
        current: 1,
        style: 'none'
      });
    },
    info: function info() {
      _natjs2.default.image.info('http://cdn.instapp.io/nat/samples/yellow-metal.jpg', function (err, ret) {
        _natjs2.default.toast(JSON.stringify(ret));
      });
    },
    exif: function exif() {
      _natjs2.default.image.exif('http://cdn.instapp.io/nat/samples/yellow-metal.jpg', function (err, ret) {
        if (err) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Pick image from gallery")])])
