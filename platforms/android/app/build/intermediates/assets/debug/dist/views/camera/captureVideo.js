...
var _captureVideo = __webpack_require__(60);

var _captureVideo2 = _interopRequireDefault(_captureVideo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_captureVideo2.default.el = '#root';
new Vue(_captureVideo2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/camera/captureVideo.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e0885456"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    preview: function preview() {
      if (!this.path) {
        _natjs2.default.toast('please take your video first');
        return;
      }
      _natjs2.default.video.play(this.path);
    }
  }
};
