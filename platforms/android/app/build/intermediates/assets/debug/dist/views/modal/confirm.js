...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/layout/titleBar.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b3274dd2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
if (weex && weex.requireModule || typeof __weex_define__ === 'function') {
	...
	var communication = __webpack_require__(16);
	var geolocation = __webpack_require__(17);
	var media = __webpack_require__(18);
	var modal = __webpack_require__(22);
	var recorder = __webpack_require__(23);
	var network = __webpack_require__(24);
	var sensor = __webpack_require__(27);
	var device = __webpack_require__(30);
	var Navigator = __webpack_require__(37);
	var alipay = __webpack_require__(38);
	var wechat = __webpack_require__(39);
...
var _audio = __webpack_require__(19);
...
var _compass = __webpack_require__(29);
...
var _battery = __webpack_require__(32);
...
var _screen = __webpack_require__(34);

var _screen2 = _interopRequireDefault(_screen);

var _vibration = __webpack_require__(35);
...
_confirm2.default.el = '#root';
new Vue(_confirm2.default);
...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/modal/confirm.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7ae84ab4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _natjs = __webpack_require__(14);
...
exports.default = {
  ...
  methods: {
    confirm: function confirm() {
      _natjs2.default.confirm('this is a confirm dialog');
    },
    confirmCustom: function confirmCustom() {
      _natjs2.default.confirm({
        title: 'Title',
    ...
    confirmWithCb: function confirmWithCb() {
      _natjs2.default.confirm('This is a confirm dialog with callback', function (err, ret) {
        _natjs2.default.toast(ret ? 'confirmed' : 'canceled');
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("\n        Nat.confirm('this is a confirm dialog')\n      ")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.confirmCustom
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["code"]
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Confirm with title, message and buttons")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["header"]
  }, [_c('text', {
