...
__vue_options__.__file = "/Users/weenta/01data/03weex/demo_nat_explorer2/src/views/media/video.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e09f3334"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    play: function play() {
      _natjs2.default.video.play('http://cdn.instapp.io/nat/samples/video.mp4', function () {
        _natjs2.default.toast('started');
        console.log('----->started');
      });
    },
    pause: function pause() {
      _natjs2.default.video.pause(function () {
        _natjs2.default.toast('paused');
      });
    },
    stop: function stop() {
      _natjs2.default.video.stop(function () {
